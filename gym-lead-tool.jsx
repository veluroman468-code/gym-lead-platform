...
function generatePlan(details, answers, report) {
  ...
  const templates = {
    "Lose Fat": [
      ["Monday", "Full Body Strength", "Squats 4x12 · Push-ups 3x15 · Rows 3x12 · Plank 3x40s"],
      ["Tuesday", "Cardio + Core", "25-min incline walk · Leg raises 3x12 · Bicycle crunches 3x20"],
      ["Wednesday", "Upper Body", "DB Press 3x12 · Lat Pulldown 3x12 · Lateral Raises 3x15"],
      ["Thursday", "Active Recovery", "Light stretching or 20-min walk"],
      ["Friday", "Lower Body", "Lunges 3x12 · Romanian Deadlifts 3x10 · Calf Raises 3x20"],
      ["Saturday", "HIIT Cardio", "20-min intervals, 30s on / 30s off"],
      ["Sunday", "Rest", "Full recovery + meal prep"],
    ],
    "Build Muscle": [
      ["Monday", "Chest & Triceps", "Bench Press 4x8 · Incline DB Press 3x10 · Tricep Dips 3x12"],
      ["Tuesday", "Back & Biceps", "Pull-ups 4x8 · Barbell Rows 3x10 · Bicep Curls 3x12"],
      ["Wednesday", "Rest / Mobility", "Light stretching, foam rolling"],
      ["Thursday", "Legs", "Squats 4x8 · Leg Press 3x12 · Romanian Deadlifts 3x10"],
      ["Friday", "Shoulders & Core", "Overhead Press 4x8 · Lateral Raises 3x15 · Hanging Leg Raises 3x12"],
      ["Saturday", "Arms + Weak Points", "Superset curls & extensions, 4x12"],
      ["Sunday", "Rest", "Full recovery"],
    ],
  };
  const defaultTemplate = [
    ["Monday", "Full Body", "Squats 3x12 · Push-ups 3x12 · Rows 3x12"],
    ["Tuesday", "Cardio", "25-min moderate cardio"],
    ["Wednesday", "Upper Body", "DB Press 3x12 · Lat Pulldown 3x12"],
    ["Thursday", "Rest", "Stretching or light walk"],
    ["Friday", "Lower Body", "Lunges 3x12 · Deadlifts 3x10"],
    ["Saturday", "Cardio + Core", "20-min cardio · Plank 3x40s"],
    ["Sunday", "Rest", "Full recovery"],
  ];
  const workoutDays = (templates[goal] || defaultTemplate).map(([day, focus, exercises]) => ({ day, focus, exercises }));

  const dietMeals = {
    Vegetarian: [
      ["Breakfast", "Oats with milk, banana, and a handful of almonds"],
      ["Mid-Morning", "Greek yogurt with mixed nuts"],
      ["Lunch", "Brown rice, paneer curry, mixed vegetable salad"],
      ["Evening", "Protein shake + fruit"],
      ["Dinner", "Dal, roti, sabzi, and curd"],
    ],
    Vegan: [
      ["Breakfast", "Overnight oats with plant milk and chia seeds"],
      ["Mid-Morning", "Roasted chickpeas and almonds"],
      ["Lunch", "Quinoa, tofu stir-fry, mixed greens"],
      ["Evening", "Plant-based protein shake"],
      ["Dinner", "Lentil curry, brown rice, sautéed vegetables"],
    ],
    Keto: [
      ["Breakfast", "Scrambled eggs with avocado and spinach"],
      ["Mid-Morning", "A handful of macadamia nuts"],
      ["Lunch", "Grilled chicken, olive oil salad, cheese"],
      ["Evening", "Boiled eggs"],
      ["Dinner", "Salmon with buttered greens"],
    ],
    "High-Protein": [
      ["Breakfast", "4 egg whites + 2 whole eggs, oats"],
      ["Mid-Morning", "Protein shake"],
      ["Lunch", "Grilled chicken breast, brown rice, salad"],
      ["Evening", "Cottage cheese + fruit"],
      ["Dinner", "Fish or lean meat, steamed vegetables"],
    ],
    "No Restrictions": [
      ["Breakfast", "Oats with banana and 2 boiled eggs"],
      ["Mid-Morning", "Greek yogurt + mixed nuts"],
      ["Lunch", "Brown rice, grilled chicken, salad"],
      ["Evening", "Protein shake + fruit"],
      ["Dinner", "Dal, roti, sabzi and curd"],
    ],
  };
  const meals = (dietMeals[diet] || dietMeals["No Restrictions"]).map(([meal, items]) => ({ meal, items }));
    ...
    <div className="fadeUp">
      ...
      <div style={S.card}>
        ...
        <div style={{ fontSize: 13, color: "#ccc", lineHeight: 1.8 }}>
          <div><strong style={{ color: TEXT }}>Split:</strong> {answers.goal === "Build Muscle" ? "Push / Pull / Legs" : "Full Body / Upper-Lower"}, {report.bodyScore > 70 ? "4-5" : "3"}x weekly</div>
